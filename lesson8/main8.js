...
var products = {
    "ear": {
        name: 'Сережки',
        price: 40,
        image: "../lesson8/img/earrings.jpg"
    },
    "bra": {
        name: 'Браслет',
        price: 150,
        image: "../lesson8/img/bracelet.jpg"
    },
    "ring": {
        name: 'Кольцо',
        price: 100,
        image: "../lesson8/img/ring.jpg"
    }
};
...
var toBasket = document.querySelectorAll('button.btn');
toBasket.forEach(function (basketBtn) {
    basketBtn.addEventListener('click', addToBasket.bind(products[key])); // надеюсь я правильно понимаю, что bind добавляется сюда, только не понимаю, что написать в скобках, чтобы корректно выдавал ключ
})

function addToBasket() {
    var articul = this.products[key]; // и здесь, как понимаю, должно хватать this (и так на каждой кнопке). 
